...
sgtitle('1st Iteration Potentiometer Characteristics Graph', 'Interpreter','latex');

Xaxes = FirstPercentTable.Travel;
Yaxes = [FirstPercentTable.RoA, FirstPercentTable.RoB, FirstPercentTable.RoC, FirstPercentTable.LiA, FirstPercentTable.LiB];
XError = (0:5:100);
for i = 1:21
    m = mod(i, 2);
    if m == 0
